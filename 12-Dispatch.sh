...
VALIDATE $? "Installed packages from go mod init"

go get  &>>$LOGS_FILE
VALIDATE $? "Installed packages from go get"

go build  &>>$LOGS_FILE
VALIDATE $? "Installed packages from go build"
...
VALIDATE $? "Enabled and Started Dispatch"